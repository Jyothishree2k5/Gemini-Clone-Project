...
const Main = () => {
  ...
  return (
    <div className='main'>
      ...
      <>
            <div className="greet">
            <p><span>Hello,Jyothi</span></p>
            <p>How can I help you today?</p>
          </div>
          <div className="cards">
              <div className="card">
                <p>List some beautiful places to visit in India</p>
              ...
              <div className="card">
                <p>List some must read books on self improvement</p>
                <img src={assets.message_icon}alt="" />
              </div>
              <div className="card">
                <p>Provide the SQL code for the given program</p>
